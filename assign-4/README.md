...
About
----
This program is an updated version of the program from Assignment 3. 
The simulation controls within this version have been reorganized 
and expanded. Many of the new controls have not been fully 
implemented, such as the controls that display math functions, point
cloud files, and animations. These incomplete controls will be
worked on in future versions of the program.
...
----
    ...
    cd software-design-spring2014/assign-4
    qmake
    make
    ./ledcube
